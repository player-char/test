...
var responses = [
	...
	*/
	...
	// dank words
	{
		p: /(^|[^а-яё])(ч[ёео]-?нить|пели(л|ть)|[ыъь]{2,}|афф|з?а+з+а+з+|а+х+а+х+|л[ыуа]л|лел[ьлок]|сми[щш]но|дратут|пей(сат|ш[иеы]т)|пр[еюяё]й?ве[тд]|прифф?(е[тд]|к)|прекол|у?збаг|ниасил|миня|ата(ш[оеё]л|йд)|ухади|(нит|ды|[мт]я|[чшки]та|(те([бп]е)?|мн[еи]|[еи](й|му?)|нам) плоха)([^а-яё]|$))/i,
		m: 'react',
		r: '💉',
	},
	...
	// кто такой кто-то
	{
		...
		r: (m, flags, floodey, message) => {
			let known = {
				...
				'(зомби|zombie)': 'Зомби — живой мертвец.',
