...
var responses = [
	...
	*/
	...
	{
		d: true,
		p: /^ *((больше )?не (болей|флуди|кр[ау]ш((ай)?ся|ись)|(страд|пад|уныв|сдых|умир)ай( духом)?|(покид|брос)ай (нас|меня))( больше)?(, ладно)?|живи|будь (здоров|онлайн|с нами|со мной))(, (а|ладно|хорошо|ясно|поня(тно|л)|ок|да|(не )?будешь( больше)?|постараешься))*[!?., ]*$/i,
