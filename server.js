...
let known = {
	...
	'([жг][ _-]?б(и|еа)р|g[ _-]?bear)': 'GBear — эзотерический язык программирования, написанный Гетапом от нечего делать.',
	...
	'(канал|channel)': 'канал — рукотворная канава для притока или отвода флуда.',
