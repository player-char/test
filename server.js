...
var responses = [
	...
	// номер телефона?
	{
		...
		r: () => 'вот мой телефонный номер: ' + -0 * +79112556565 / 0 + '.',
	},
	...
	{
		d: true,
		p: /^ *((как(ова|ая) )?((твоя|у тебя) )?версия|(скаж|напиш)и (свою )?версию)[!?., ]*$/i,
		r: 'она написана на упаковке.',
	},
	...
	{
		d: true,
		p: /(^|[^а-яё])(как ты|ты-то как)([^а-яё]|$)/i,
		r: 'я так.',
	},
	...
	// :race_car:
	{
		p: /(^|[^а-яёa-z])г(на(л([аои](сь)?|ся)?|ть)?|они(шь|те)?)/i,
		m: 'react',
		r: '🏎',
	},
...
var alreadyLaunched = !!alreadyLaunched;
// сразу, как зайдёт
client.on('ready', () => {
