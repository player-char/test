...
var responses = [
	...
	// dirtey words
	{
		p: /(^|[^а-яё])((по|на|за|вы|у|про)?(си?ра[тлчкш]|сри(^|[^а-яё]|т))|д[еёи]рьм|г[оа]ве?н|ж[оеё]п|ан(ус|ал)|(на|за|вы|об|раз)?бл[её]в|(вы|на|обо)?сс[ыа]|shit)/i,
		m: 'react',
		r: '🚽',
	},
	...
	// dank words
	{
		p: /(^|[^а-яё])(ыы|афф|азаз|л[ыеуа]л|сми[щш]но|дратут|пей(сат|ш[иеы]т)|пр[еюяё]й?ве[тд]|прифф?(е[тд]|к)|прекол|узбаг|ниасил|миня|ата(ш[оеё]л|йд)|ухади|(нит|ды|[чшки]та)([^а-яё]|$))/i,
		m: 'react',
		r: '💉',
	},
