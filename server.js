...
let responses = [
	...
	*/
	...
	{
		d: true,
		p: /^ *(иди|п[оа]ш[ёео]л|провали(вай|сь)|вали|шагай|топай|давай|дуй|катись|ползи) (в|на|к|под) ?[а-яёa-z]+/i,
	...
	{
		d: true,
		p: /^ *(вон|проваливай|брысь|фу|прочь|п[оа]?ш[ёео]л|у(й|х[оа])ди|иди (вон|прочь|отсюда)|катись колбаской)([^а-яё]|$)/i,
