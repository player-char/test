...
var responses = [
	...
	// dirtey words
	{
		p: /(^|[^а-яё])((по|на|за|вы|у|про)?(си?ра[тлчкш]|ср[иуё])|д[еёи]рьм|г[оа]ве?н|ж[оеё]п|ан(ус|ал)|(на|за|вы|об|раз)?бл[её]в|(вы|[нз]а|обо|про)?сс(?!ы[лпх]|у([чдж]|ту)|а[дж])[ыау]|shit)/i,
		m: 'react',
		r: '🚽',
	},
