	...
	// кто такой кто-то
	{
		...
		r: (m, floodey, message) => {
			let known = {
				...
				'((г|дж)[еи]тт?[ау]п|getup)': 'Гетап — каститизатор Земель Рандомских.',
				'(оранж|кастер)': '!+ 🍹',
				...
				'((мк)?тролль?|mktroll)': 'MKTroll — парень, запомнившийся клановыми войнами с ACSG и Легионом, а также желанием уничтожить Лайкобск.',
				...
				'(рикос|ric?kos)': 'Rickos — minecraft-сервер, идеей которого является РПГ, плотно сотрудничающий с ZombiesLand.',
				'(з[оа]мбис? ?л[эе]нд|zombie\'?s? ?land|(zl|зл)(?![а-яёa-z]))': 'ZombiesLand — minecraft-сервер, основной идеей которого является хардкор.',
