...
var responses = [
	...
	// зарплата?
	{
		...
		r: 'мне не нужна зарплата, чтобы существовать.',
	},
	...
	// кто такой кто-то
	{
		...
		r: (m, flags, floodey, message) => {
			let known = {
				...
				'л(ай|и)кобск': () => 'Лайкобск — город, свободный от ' + ['курения', 'коробкофобов', 'овцемобилей', 'гриферства'].pick() + '.',
	...
	{
		d: true,
		p: /(^|[^а-яё])представляешь([^а-яё]|$)/i,
		r: 'что-то как-то не особо представляю.',
	},
