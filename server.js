...
const known = {
	...
	'банан|banana': ['+', '🍌'],
	'google[ -]?crasher|гуго?л[ео -]?кр[ау]с?ш(ер|а)?': 'GoogleCrasher — модератор, всеми силами пытающийся вытянуть РнКр из канавы.',
	...
	'[cс]и?([3з]|три)[ _-]?(г[ау]ст|gust)|c3|gust': 'C3_Gust — нынешний владелец сервера ZombiesLand, который плотно сотрудничает с Rickos RPG.',
	...
	'(игрок|пл[еао]ер|player)[ _-]?(чар|char)': 'спроси у него сам, кто он такой.',
