...
var responses = [
	...
	// dank words
	{
		p: /(^|[^а-яё])(сми[щш]но|дратут|пей(сат|ш[иеы]т)|пр[еюяё]й?ве[тд]|прифф?е[тд]|узбаг|ниасил|миня|ата(ш[оеё]л|йд)|ухади|(нит|ды|[чшки]та)([^а-яё]|$))/i,
		m: 'react',
		r: '💉',
	},
	...
	// norm or better?
	{
		p: /(^|[^а-яё])[а-яё]{3,}[нтвх]о или [а-яё]{3,}[нтвх]о[?]+$/i,
		r: () => [
			'прекрасн',
			'восхитительн',
			'велеколепн',
