...
let responses = [
	...
	{
		d: true,
		p: /(^|[^а-яё])на чём (ты )?(сейчас )?работаешь[?! ]*$/i,
	...
	{
		d: true,
		p: /(^|[^а-яё])(на|в) (чём|каком редакторе) ты написан[?! ]*$/i,
		r: 'на Notepad++.',
	},
	// как дела?
	{
	...
	{
		d: true,
		p: /(^|[^а-яё])в чём смысл жизни[?! ]*$/i,
		r: 'ответ: смысла жизни нет. Но в то, что его нет, верить не выгодно, поскольку вера в это так или иначе уменьшает шанс выживания. Так что как-то так.',
	},
	...
	{
		d: true,
		p: /(^|[^а-яё])(как д(авн|олг)о|сколько времени) ты (онлайн|работаешь|запущен)[?! ]*$/i,
		r: () => {
