...
var responses = [
	...
	// bad words
	{
		p: /(^|[^а-яё"'`])(д(ау|ове)н|кр[ие]тин|тупица|аути(зм|ст)|имбицил|чмо|с[еэ]кс|минь?ет|[ао]н[ао]ни[рз]|дег(енер|рад)|свол[ао]ч|мраз|мерзав|паршив|ло[хш]|ублюд|дур[аоеё]|д[еи]б[еи]л|тупица|гом(ик|осек))/i,
		m: 'react',
		r: '🥀',
	},
	...
	// bad words with you
	{
		p: /((^|[^а-яё"'`])[тв]ы[^а-яё]*|[‐-―-] *)(туп(ой|ая|ое)|мерзк(ий|ая|ое)|паразит|б[яа]ка|ид[ие]от|никто|(ни ?кому )?н[еи] нуж(ен|н(ы|а)))/i,
	...
	// too complex
	{
		p: /(^|[.,!?] ?|\n)((?!не )[^!?. "'-]+[ "'-])*сложн[ао]( (очень|как-то|совсем|слишком|это|будет))* *([!?.]+|$)/i,
		m: 'creact',
		r: 'kamka',
	},
