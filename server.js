...
var responses = [
	...
	// bad words with you
	{
		p: /((^|[^а-яё"'`])[тв]ы[^а-яё]*|[‐-―-] *)(туп(ой|ая|ое)|мерзк(ий|ая|ое)|паразит|ид[ие]от|никто|(ни ?кому )?н[еи] нуж(ен|н(ы|а)))/i,
	...
	// bad words
	{
		p: /(^|[^а-яё"'`])(д(ау|ове)н|кр[ие]тин|тупица|аути(зм|ст)|имбицил|чмо|с[еэ]кс|минь?ет|[ао]н[ао]ни[рз]|дег(енер|рад)|свол[ао]ч|мраз|мерзав|паршив|ло[хш]|ублюд|дур[аоеё]|д[еи]б[еи]л|б[яа]ка|тупица|гом(ик|осек))/i,
		m: 'react',
		r: '🥀',
	},
	...
	{
		d: true,
		p: /^ *(не (болей|флуди|кр[ау]ш((ай)?ся|ись)|(страд|пад|уныв|сдых|умир)ай( духом)?|(покид|брос)ай (нас|меня))|живи|будь (здоров|онлайн|с нами|со мной))[!. ]*$/i,
	...
	// :creeper:
	{
		p: /(^|[^а-яё])(creep(?!er)|(?!крип(то|ер([аыуе]|[оа]м|а(х|ми))?(?![а-яё])))(от?|[нзвпд][аыое]|(и|ра)[сз]|пе?ре|недо)?крип)/i,
		c: 0.9,
		m: 'creact',
		r: 'creeper',
	},
