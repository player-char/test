...
var responses = [
	...
	// nastey words
	{
		p: /((^|[^а-яё])(([аов]|[су](?!трах)|(пр|[дзвпн])[аеёиыяюео]|(р[ао]|в)[сз]|[оа]т)?(ху[йеяюиё]|др(оч|ач(?!л))|п[ие]д[аои](?![нл])|трах(?!е[яюией]))|([её]|йо)б|муд[аеёиыяюо]|(вы|у)?[бм]л(я|э(?![кс]))|([её]|йо)пт)|[ьъоаеёу]([её]|йо)б|[оеёс]ху[йеяюиё]|п[иеёюй]з[жд]|параш|гандон|(fu|di)ck)/i,
		r: 'please, be polite!',
	},
	...
	// dirtey words
	{
		p: /(^|[^а-яё])((по|на|за|вы|у|про)?(си?ра[тлчкш]|ср[иуё])|д[еёи]рьм|г[оа]ве?н|ж[оеё]п|ан(ус|ал(?![ио]))|(на|за|вы|об|раз)?бл[её]в|(вы|[нз]а|обо|про)?сс(?!ы[лпх]|у([чдж]|ту)|а[дж])[ыау]|shit)/i,
		m: 'react',
		r: '🚽',
	},
