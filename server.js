...
var responses = [
	...
	// dank words
	{
		p: /(^|[^а-яё])([ыъь]{2,}|афф|з?а+з+а+з+|а+х+а+х+|л[ыуа]л|лел[ьлок]|сми[щш]но|дратут|пей(сат|ш[иеы]т)|пр[еюяё]й?ве[тд]|прифф?(е[тд]|к)|прекол|у?збаг|ниасил|миня|ата(ш[оеё]л|йд)|ухади|(нит|ды|[чшки]та)([^а-яё]|$))/i,
		m: 'react',
		r: '💉',
	},
	...
	// кто ты?
	{
		...
		r: 'не задавай глупых вопросов, ладно?',
	},
	...
	// когда
	{
		d: true,
		p: /^ *когда крип/i,
		r: 'когда Гетап Рандомию доделает.',
	},
	{
		d: true,
		p: /^ *когда([^а-яё]|$)/i,
		r: 'когда крипак на горе свистнет.',
	},
	...
	// :питон:
	{
		p: /(^|[^а-яёa-z])питон[чико]|(зм|сн)ейк|snake/i,
		m: 'react',
		r: '🐍',
	},
