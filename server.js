...
let known = {
	...
	'(комп(ьютер)?ы?(?![а-яё])|computer)': 'компьютер — программируемое электронное устройство для обработки информации.',
