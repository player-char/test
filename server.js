...
// инициализация
const myId = '311163859580747778';// Дискорд-бот "Крипушка"
...
let responses = [
	...
	{
		d: true,
		p: /(^|[^а-яё])где (ты )?(((обит|пр?ожив)ае|живё)шь|находишься)[?! ]*$/i,
		r: 'на сервере.',
	},
	...
	// не о чем разговаривать
	{
		...
		r: 'сложно тему для разговора придумать, разве нет?',
	},
	...
	// кто такой кто-то
	{
		...
		r: (m, flags, floodey, message) => {
			let known = {
				...
				'(л(ай|и)коб|lik0oob)': 'Лайкоб — основатель города Лайкобск.',
