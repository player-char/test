...
var responses = [
	...
	// bad words
	{
		p: /(^|[^а-яё"'`])(д(ау|ове)н|кр[ие]тин|тупица|аути(зм|ст)|имбицил|чмо|с[еэ]кс|минь?ет|[ао]н[ао]ни[рз]|дег(енер|рад)|свол[ао]ч|мраз|мерзав|паршив|ублюд|дур[аоеё]|д[еи]б[еи]л|тупица|ничтожество|гом(ик|осек))/i,
		m: 'react',
		r: '🥀',
	},
	...
	// bad words with you
	{
		p: /((^|[^а-яё"'`])([тв]ы|крип(уш(ка|ек)|ер(аст)?|ак?))[^а-яё]*|[‐-―-] *)(туп(ой|ая|ое)|мерзк(ий|ая|ое)|ло[хш]|(ничтожн|глуп)(ы[йш]|ая?|ое?)|убожество|паразит|б[яа]ка|ид[ие]от|ни[кчш]то|(ни ?кому )?н[еи] нуж(ен|н(ы|а)))/i,
		m: 'react',
		r: '🥀',
	},
